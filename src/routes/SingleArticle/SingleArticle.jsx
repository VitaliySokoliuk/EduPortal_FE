...
const tasks = [
    {
        task_content: 'Створити програму, використовуючи вивчені принципи ООП, описати створену програму за допомогою коментарів у коді',
        max_mark: 10,
        taskNum: 1,
        cDate: 'Tue, Oct 17th 2023'
    },
    {
        task_content: 'Описати декількома реченнями головні особливості кожного принципу об’єктно орієнтованого програмування',
        max_mark: 10,
        taskNum: 2,
        cDate: 'Fri, Oct 20th 2023'
    }
]
...
export default function SingleArticle() {
    return (
        <>
            <Header />
            <div className="taras_superhero_and_likes_cucumbers p-5 ml-3 mr-3">
                <h1 class="mb-5">Принципи ООП з Java</h1>
                ...
                <p>Точніше,
                    <strong>поліморфізм -</strong> один з принципів ООП, який дозволяє викликом перевизначеного методу через змінну батьківського класу отримати поведінку, яка буде відповідати реальному похідному класу, на який посилається ця змінна. <br />
